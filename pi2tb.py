...
EXT0, EXT1, EXT2, EXT3 = POS_AIN0|NEG_AINCOM, POS_AIN1|NEG_AINCOM, POS_AIN2|NEG_AINCOM, POS_AIN3|NEG_AINCOM
EXT4, EXT5, EXT6, EXT7 = POS_AIN4|NEG_AINCOM, POS_AIN5|NEG_AINCOM, POS_AIN6|NEG_AINCOM, POS_AIN7|NEG_AINCOM
...
CH_OFFSET = np.array((0,   0,   0,   0,   0,   0,   0,   0), dtype=np.int)
...
ACCESS_TOKEN = 'a1JY4rpycc3wHeyR3kYU'
